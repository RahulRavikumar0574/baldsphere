  ...
  return (
    <group>
      ...
      {highlightedRegions.includes('Parietal') && (
        <mesh position={[0, 0.18, 0]} scale={[0.035, 0.035, 0.035]} rotation={[0, 0, 0]}>
      ...
      {highlightedRegions.includes('Frontal') && (
        <mesh position={[0, 0.02, 0.15]} scale={[0.03, 0.03, 0.03]} rotation={[Math.PI / 2, 0, 0]}>
          <coneGeometry args={[1, 3, 6]} />
      ...
      {highlightedRegions.includes('Temporal') && (
        <>
          <mesh position={[0.15, 0, 0]} scale={[0.03, 0.03, 0.03]} rotation={[0, 0, -Math.PI / 2]}>
            <coneGeometry args={[1, 3, 6]} />
