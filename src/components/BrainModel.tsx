  ...
  return (
    <group>
      ...
      {highlightedRegions.includes('Parietal') && (
        <mesh position={[0, 0.15, 0]} scale={[0.02, 0.02, 0.02]} rotation={[Math.PI, 0, 0]}>
      ...
      {highlightedRegions.includes('Frontal') && (
        <mesh position={[0, 0.02, 0.12]} scale={[0.015, 0.015, 0.015]} rotation={[-Math.PI / 2, 0, 0]}>
          <coneGeometry args={[1, 3, 6]} />
      ...
      {highlightedRegions.includes('Temporal') && (
        <>
          <mesh position={[0.12, 0, 0]} scale={[0.015, 0.015, 0.015]} rotation={[0, 0, Math.PI / 2]}>
            <coneGeometry args={[1, 3, 6]} />
